(function (window, document, $, undefined) {
	...
	function initSlider(selector, cellSelector) {
		cellSelector = cellSelector || '.slider__item';

		var slider = $(selector).flickity({
		...
		slider.on({
			'touchstart': function () {
				var flickity = $.data(this, 'flickity');

				if (flickity && flickity.stopPlayer) {
					flickity.stopPlayer();
				}
			},
			'touchend touchcancel': function () {
				...
				if (flickity && flickity.activatePlayer) {
