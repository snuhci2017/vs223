...
var adbayControllerClass = function() {
	...
	this.setParameter = function(uis, media, clickParam, callback, isRefresh, product_idx, category, passback, info) {
		...
		this.parameter		= $.base64("encode", "host=" + this.host + "&uis=" + uis + "&limit=" + this.adsLimit + "&media=" + media + "&clk_param=" + escape(clickParam) + "&cb=" + escape(callback) + "&isRefresh=" + isRefresh + referrer + "&prd_idx=" + product_idx + "&category=" + category + "&pb=" + escape(passback)  + "&info=" + info + "&plcam="+_camIds.join(','));
	};
...
*/
	...
	adbayController.setParameter(inventoryUIs, getParameterByName("media"), getParameterByName("clk_param"), getParameterByName("callback"), isRefresh, getParameterByName("prd_idx"), getParameterByName("category"), getParameterByName("pb"), getParameterByName("info"));
