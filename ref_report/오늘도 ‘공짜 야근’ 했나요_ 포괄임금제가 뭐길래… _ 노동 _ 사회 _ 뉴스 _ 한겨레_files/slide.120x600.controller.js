// 콜백 함수
function adbaySlideBannerCallback120x600()
{
	$("#slideBanner").show();
	...
	retargetBnr.Data = {
		...
		Class : 'rb_120x600',		// 추가할 클래스명
		moveType : 'horizon',		// 모션 타입(vertical, horizon선)
		width : 120,				// 박스 가로폭
		height : 600,				// 박스 세로폭
		viewLength : 3, 			// 화면에 보여지는 베너 갯수
		MarginLeft : 0,				// 코딩별 ul 요소의 마진값이 달라서...
		MarginTop : -4, 			// 코딩별 ul 요소의 마진값이 달라서...
